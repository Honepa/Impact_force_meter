...
void loop()
{
  ...
  if (client)
  {
    if (request.indexOf("/40_sec") != -1)
    {
      ...
      client.println("<body>");
      client.println("<h1 align='center'> IFM - 02 </h1>");
      client.println("</body>");
      count_imp = 0;
      t_red = millis();
      ...
      client.println("<script>window.location.href = 'http://192.168.88.201'</script>");
